...
class _$LoginEventTearOff {
  ...
  _Login login(String credential, String password) {
    return _Login(
      credential,
      password,
    );
...
class _$_Login implements _Login {
  const _$_Login(this.credential, this.password);
  ...
  @override
  String toString() {
    return 'LoginEvent.login(credential: $credential, password: $password)';
  }
...
abstract class _Login implements LoginEvent {
  const factory _Login(String credential, String password) = _$_Login;
